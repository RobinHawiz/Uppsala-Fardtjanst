...
burgerking.setAttribute("aria-label", "Meny");
...
function toggleNavbar() {
  ...
  if (!nav.classList.contains("opened")) {
    ...
    // We set the aria-label to "Stäng meny" for people who use screen readers, otherwise the menu will be read as "Stäng", which might not make as much sense.
    burgerking.setAttribute("aria-label", "Stäng meny");
